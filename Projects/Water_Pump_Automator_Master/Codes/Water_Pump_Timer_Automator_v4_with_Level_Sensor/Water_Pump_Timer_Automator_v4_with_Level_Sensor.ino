...
const uint16_t time_on = ((uint16_t) 40 * 1000); // seconds to milliseconds // REAL TIMER 
uint32_t time_off = ((uint32_t) 10 * 60000); // minutes to milliseconds // REAL TIMER

/*
const uint16_t time_on = ((uint16_t) 3 * 1000); // seconds to milliseconds // FOR QUICK TESTS
uint32_t time_off = ((uint32_t) 0.2 * 60000); // minutes to milliseconds // FOR QUICK TESTS
*/
